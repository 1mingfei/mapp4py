...
/*--------------------------------------------
 constructor
 --------------------------------------------*/
PGCMC_2::PGCMC_2(AtomsMD*& __atoms, ForceFieldMD*&__ff, DynamicMD*& __dynamic, int __m, elem_type __gas_type0, type0 __mu0, type0 __T, int seed, elem_type __gas_type1,type0 __mu1, type0 __ratio):
